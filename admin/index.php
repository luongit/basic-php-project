...
// sau do goi lai hàm load_template_admin();
require_once 'header.php'; // file header.php trong thư mục admin/header,php
	load_template_admin();
require_once 'footer.php';// file footer.php trong thư mục admin/footer,php
